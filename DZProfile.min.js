...
$(window).load(function(){$('.owl-carousel').owlCarousel({animateOut: 'zoomOutRight', animateIn: 'zoomInLeft', items:1, autoplay:true, autoplayTimeout:5000, stagePadding:0, nav:true, loop:true, navText:["", ""]});});
